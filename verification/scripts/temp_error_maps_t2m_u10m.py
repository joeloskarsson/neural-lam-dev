"""Temporary script: mean error maps for temperature_2m and wind_u_10m only."""
...
DEBUG_MODE, DEBUG_FRACTION, DEBUG_MIN_SIZE = parse_debug_runtime_args(
    "Temp error maps for t2m and u10m."
)
...
for var in ["temperature_2m", "wind_u_10m"]:
    print(f"Plotting error map: {var}")
    create_error_maps(
        ds_gt=ds_gt,
